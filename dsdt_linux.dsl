 ...
 *
 * Disassembly of dsdt_linux.aml, Tue Jan 14 22:37:04 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000F4E5 (62693)
 *     Revision         0x02
 *     Checksum         0xE9
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000011)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDDD42A98, 0x034D)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDDAEDE98, 0x10)
    ...
    Scope (_GPE)
    {
        ...
        Method (_L12, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            And (\_SB.PCI0.LPCB.SIO1.SCF8, 0xEF, \_SB.PCI0.LPCB.SIO1.SCF8)
            Stall (0x32)
            And (BANK, 0xF0, BANK)
            Or (BANK, 0x04, BANK)
            And (RE91, 0xFF, Local0)
            ...
            Store (RE41, Local0)
            Sleep (0x03E8)
            Or (\_SB.PCI0.LPCB.SIO1.SCF8, 0x10, \_SB.PCI0.LPCB.SIO1.SCF8)
